...
png("./data/41Proj/Plot4.png", width = 480, height = 480)
par(mfrow=c(2, 2))
with(EPCSub, plot(fulldate, Global_active_power, xlab="", ylab="Global Active Power", type='l'))
with(EPCSub, plot(fulldate, Voltage, xlab="datetime", ylab="Voltage", type='l'))
...
with(EPCSub, plot(fulldate, Global_reactive_power, xlab="datetime", ylab="Global_reactive_power", type='l'))
dev.off()
